...
// is nothing to quote.
func uploadFailed(id ui.FailureID, stage ui.Stage, host string, status int, detail, why string,
...
func uploadArchive(ctx context.Context, deps uploadDeps) error {
	...
	if err != nil {
		return uploadFailed(ui.IDArchiveUnreadable, ui.StageUploads, host, 0, err.Error(),
	...
	if err != nil {
		...
		return uploadFailed(ui.IDUploadAddressUnusable, ui.StageUploads, host, 0, "",
	...
	if err != nil {
		...
		case errors.Is(cause, errUploadStalled):
			return uploadFailed(ui.IDUploadStalled, ui.StageUploads, host, 0, "",
		...
		case errors.Is(cause, context.DeadlineExceeded) && !deps.ExpiresAt.IsZero():
			...
			return uploadFailed(ui.IDUploadLinkExpired, ui.StageUploads, host, 0, "", why, ui.NextFreshDeploy, next)

		case sent.Load() == 0:
			return uploadFailed(ui.IDUploadHostUnreachable, ui.StageUploads, host, 0, "",
		...
		return uploadFailed(ui.IDUploadConnectionLost, ui.StageUploads, host, 0, "",
	...
	case resp.StatusCode >= 300 && resp.StatusCode < 400:
		return uploadFailed(ui.IDUploadRedirected, ui.StageUploads, host, resp.StatusCode, "",
	...
	case resp.StatusCode == http.StatusForbidden:
		...
		return uploadFailed(id, ui.StageUploads, host, resp.StatusCode, "", why, action, next)
	}

	return uploadFailed(ui.IDUploadAnswerUnrecognised, ui.StageUploads, host, resp.StatusCode, "",
